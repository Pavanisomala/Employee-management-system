...
<body>
    ...
    <script>
        function showSection(sectionId) {
            ...
            const backgrounds = {
                home: 'url(https://static.vecteezy.com/system/resources/previews/006/684/103/non_2x/hr-management-recruitment-employment-and-headhunting-concept-depth-of-field-photo.jpg)',
                registration: 'url(https://akriviahcm.com/blog/wp-content/uploads/2024/01/features-of-employee-management-system.png)',
